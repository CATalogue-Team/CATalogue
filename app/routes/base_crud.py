    ...
    def crud_route(model_name, service, form_class, list_template, edit_template):
        ...
        def decorator(cls):
            ...
            def list():
                ...
                if model_name == 'cats':
                    items = service.get_paginated_cats(page=page, per_page=per_page)
                else:
                    items = service.get_paginated(service.model, page=page, per_page=per_page) if hasattr(service, 'get_paginated') else []
